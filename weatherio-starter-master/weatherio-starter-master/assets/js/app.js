...
export const updateWeather = function (lat, lon){
    ...
    fetchData(url.currentWeather(lat, lon), function (currentWeather) {
        ...
        card.innerHTML = `
            ...
            <div class="weapper">
                <p class="heading">${parseInt(temp)}&deg;<sup id="degrees">c</sup></p>
            ...
            for (const [index, data] of forecastList.entries()){
                ...
                windLi.innerHTML = `
                    <div class="card card-sm slider-card">
                        ...
                        <img src="./assets/images/weather_icons/direction.png" width="48" height="48" loading="lazy" alt="description" class="weather-icon" style="transform: rotate(${windDirection - 180}deg)">
